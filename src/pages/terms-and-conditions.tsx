    ...
    <MainLayout>
      <div className="bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          ...
          <h3 className="text-xl font-semibold mb-4">Updated at 2024-02-01</h3>

          <h2 className="text-2xl font-bold mb-2">General Terms</h2>
          <p className="mb-2">
            By accessing and placing an order with {appName}, you confirm that
            ...
            communication between you and {appName}.
          </p>
          <p className="mb-2">
            Under no circumstances shall {appName} team be liable for any
          ...
          <p className="mb-4">
            {appName} will not be responsible for any outcome that may occur
          ...
          <p className="mb-4">
            {appName} grants you a revocable, non-exclusive, non- transferable,
            ...
            Conditions are a contract between you and {appName} (&quot;we,&quot;
            &quot;our,&quot; or &quot;us&quot;) grants you a revocable,
          ...
          <h2 className="text-2xl font-bold mb-2">Definitions and key terms</h2>
          <p className="mb-2">For this Terms & Conditions:</p>
          ...
          <h2 className="text-2xl font-bold mb-2">Restrictions</h2>
          <p className="mb-2">
          ...
          <p className="mb-4">
            ...
            terms and conditions that apply to transactions at our company.
            We&apos;ll be as brief as our attorneys will allow. The main thing
            to remember is that by placing an order or making a purchase from
            us, you agree to the terms along with our Privacy Policy. If, for
            any reason, You are not completely satisfied with any good or
            service that we provide, don&apos;t hesitate to contact us and we
            will discuss any of the issues you are going through with our
            product.
          </p>

          <h2 className="text-2xl font-bold mb-2">Your Suggestions</h2>
          <p className="mb-4">
            Any feedback, comments, ideas, improvements or suggestions
            (collectively, &quote;Suggestions&quote;) provided by you to us with
            respect to the service shall remain the sole and exclusive property
            of us. We shall be free to use, copy, modify, publish, or
          ...
          <p className="mb-4">
            We use &quotes;Cookies&quotes; to identify the areas of our website
          ...
          <h2 className="text-2xl font-bold mb-2">Updates to Our service</h2>
          <p className="mb-4">
            ...
            (&quotes;Updates&quotes;). Updates may modify or delete certain
            ...
            the service to you. You further agree that all Updates will be (i)
          ...
          <p className="mb-4">
            ...
            (&quotes;Third- Party Services&quotes;). You acknowledge and agree
          ...
          <p className="mb-4">
            ...
            attorney&apos;s fees, due to or arising out of your: (a) use of the
            service; (b) violation of this Agreement or any law or regulation;
            or (c) violation of any right of a third party.
          </p>

          <h2 className="text-2xl font-bold mb-2">No Warranties</h2>
          <p className="mb-2">
            The service is provided to you &quotes;AS IS&quotes; and &quotes;AS
            AVAILABLE&quotes; and with all faults and defects without warranty
            ...
            and makes no representation of any kind that the service will meet
          ...
          <p className="mb-4">
            ...
            servers, the content, or e-mails sent from or on behalf of us are
          ...
          <p className="mb-4">
            ...
            used with the service, or otherwise in connection with any provision
            of this Agreement), even if we or any supplier has been advised of
          ...
          <h2 className="text-2xl font-bold mb-2">Waiver</h2>
          <p className="mb-2">
          ...
          <h2 className="text-2xl font-bold mb-2">Updates to Our Terms</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            providers of such material and are protected by Indonesia and
          ...
          <h2 className="text-2xl font-bold mb-2">Agreement to Arbitrate</h2>
          <p className="mb-4">
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR {appName}&apos;s
            ...
            basis. &quote;Dispute&quote; will be given the broadest possible
            meaning allowable under law.
          </p>

          <h2 className="text-2xl font-bold mb-2">Notice of Dispute</h2>
          <p className="mb-4">
            ...
            date the Notice of Dispute is sent. After sixty (60) days, you or us
            may commence arbitration.
          </p>

          <h2 className="text-2xl font-bold mb-2">Binding Arbitration</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-bold mb-2">Submissions and Privacy</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            sweepstakes, or other activities (&quote;Promotions&quote;) that
            ...
            abide by and to comply with all Promotions Rules. Additional terms
            and conditions may apply to purchases of goods or services on or
            through the Services, which terms and conditions are made a part of
            this Agreement by this reference.
          </p>

          <h2 className="text-2xl font-bold mb-2">Typographical Errors</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            our offices in Indonesia. The Service is not intended for
          ...
          <p className="mb-4">
            Our Service and its contents are provided &quotes;as is&quotes; and
            &quotes;as available&quotes; without any warranty or representations
            of any kind, whether express or implied. We are a distributor and
