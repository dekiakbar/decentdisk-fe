    ...
    <MainLayout title="Terms And Conditions">
      <div className="bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4 py-8">
          ...
          <h2 className="dark:text-white text-2xl font-bold mb-2">License</h2>
          <p className="dark:text-gray-400 mb-4">
          ...
          <h2 className="dark:text-white text-2xl font-bold mb-2">Cookies</h2>
          <p className="dark:text-gray-400 mb-4">
          ...
          <h2 className="dark:text-white text-2xl font-bold mb-2">Waiver</h2>
          <p className="dark:text-gray-400 mb-2">
