    ...
    <MainLayout>
      <div className="bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            We are incorporated in Indonesia. Information collected via our
          ...
          <h2 className="text-2xl font-bold mb-2">Cgildren&apos;s Privacy</h2>
          <p className="mb-4">
            We do not address anyone under the age of 17. We do not knowingly
            collect personally identifiable information from anyone under the
            age of 17. If You are a parent or guardian and You are aware that
          ...
          <p className="mb-2">
            ...
            risk and subject to such third partie&apos;s terms and conditions.
          </p>

          <h2 className="text-2xl font-bold mb-2">Tracking Technologies</h2>
          <ul className="list-disc list-inside mb-4 ml-4">
            <li className="ml-2">Cookies</li>
            <p className="mb-2">
              ...
              you visit our service as we would not be able to remember that you
              had logged in previously.
            </p>

            <li className="ml-2">Local Storage</li>
            <p className="mb-2">
